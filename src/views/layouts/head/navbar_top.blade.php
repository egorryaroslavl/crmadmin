<nav class="navbar navbar-static-top">
	<a href="blank.html#" class="sidebar-toggle" data-toggle="offcanvas" role="button">
		<!-- Sidebar toggle button-->
		<span class="sr-only">Toggle navigation</span>
		<span class="pe-7s-angle-left-circle"></span>
	</a>
	<!-- searchbar-->
	<a href="blank.html#search"><span class="pe-7s-search"></span></a>
	<div id="search">
				...
				<ul class="dropdown-menu">
					<li>
						<ul class="menu">
							<li>
								<!-- start message -->
								<a href="blank.html#" class="border-gray">
									<div class="pull-left">
				...
				<ul class="dropdown-menu">
					<li>
						<ul class="menu">
							...
							<li><a href="blank.html#" class="border-gray">
